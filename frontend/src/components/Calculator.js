...
function Calculator() {
    ...
    const addStock = () => {
        setStocks([...stocks, { id: nextId, symbol: '', currentPrice: '', sharesOwned: '', futurePrice: '' }]);
        setNextId(nextId + 1);
    };
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px' }}>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => updateStock(stock.id, 'currentPrice', e.target.value)}
                                    placeholder="0.00"
                                    min="0"
                                    step="0.01"
                                />
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => updateStock(stock.id, 'sharesOwned', e.target.value)}
                                    placeholder="0"
                                    min="0"
                                    step="1"
                                />
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => updateStock(stock.id, 'futurePrice', e.target.value)}
                                    placeholder="0.00"
                                    min="0"
                                    step="0.01"
                                />
